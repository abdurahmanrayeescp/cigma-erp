...
export default function StudentHomeworkPage() {
  ...
  useEffect(() => {
    if (!classId) {
      setLoading(false)
      setError('You are not currently assigned to any class. Please contact the administrator.')
      return
    }

    homeworkApi.getClassHomework(classId)
      .then(res => {
    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-navy-900 rounded-2xl p-8 text-center border border-gray-100 dark:border-white/5 shadow-sm">
          ...
          <p className="text-gray-500 dark:text-gray-400 font-medium">No homework assignments found for your class.</p>
        </div>
      ) : (
